...
ALTER TABLE finance_management.user_paid_subscription ADD CONSTRAINT user_paid_subscription_fk FOREIGN KEY (user_id)
        REFERENCES finance_management.money_waste(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.money_waste ADD CONSTRAINT money_waste_fk FOREIGN KEY (user_id)
        REFERENCES user_management.finance_user(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.user_invest_piggy_bank_statistics ADD CONSTRAINT user_invest_piggy_bank_statistics_fk FOREIGN KEY (user_id)
        REFERENCES user_management.finance_user(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.user_investing_properties ADD CONSTRAINT user_investing_properties_fk FOREIGN KEY (user_id)
        REFERENCES user_management.finance_user(id);

ALTER TABLE finance_management.user_money_spent_statistics ADD CONSTRAINT user_money_spent_statistics_fk FOREIGN KEY (user_id)
        REFERENCES user_management.finance_user(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.user_money_waste_properties ADD CONSTRAINT user_money_waste_properties_fk FOREIGN KEY (user_id)
        REFERENCES finance_management.money_waste(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.user_savings_account_statistics ADD CONSTRAINT user_savings_account_statistics_fk FOREIGN KEY (user_id)
        REFERENCES finance_management.money_waste(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE finance_management.user_tinkoff_investing_statistics ADD CONSTRAINT user_tinkoff_investing_statistics_fk FOREIGN KEY (user_id)
        REFERENCES user_management.finance_user(id) ON DELETE CASCADE ON UPDATE CASCADE;
